...
const getCharacterById = async (id) => {
  const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL_LOCAL}/api/characters/${id}`);
...
const getComicsByCharacterId = async (id) => {
  const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL_LOCAL}/api/characters/${id}/comics`);
...
const getEventsByCharacterId = async (id) => {
  const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL_LOCAL}/api/characters/${id}/events`);
...
const getSeriesByCharacterId = async (id) => {
  const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL_LOCAL}/api/characters/${id}/serials`);
