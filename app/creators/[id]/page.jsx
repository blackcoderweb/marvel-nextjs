...
const getCreatorById = async (id) => {
  const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL_LOCAL}/api/creators/${id}`);
...
const getComicsByCreatorId = async (id) => {
  const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL_LOCAL}/api/creators/${id}/comics`);
...
const getEventsByCreatorId = async (id) => {
  const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL_LOCAL}/api/creators/${id}/events`);
...
const getSeriesByCreatorId = async (id) => {
  const res = await fetch(`${process.env.NEXT_PUBLIC_BASE_URL_LOCAL}/api/creators/${id}/serials`);
